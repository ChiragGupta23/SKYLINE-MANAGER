  ...
  Style_createClass(Style, [{
    ...
    value: function current(rng) {
      ...
      if (!rng.isOnList()) {
        ...
        var orderedType = ['circle', 'disc', 'disc-leading-zero', 'square'];
        var isUnordered = orderedType.indexOf(styleInfo['list-style-type']) > -1;
    ...
    value: function attachDragAndDropEvent() {
      ...
      this.$dropzone.on('drop', function (event) {
        ...
        if (dataTransfer && dataTransfer.files && dataTransfer.files.length) {
          ...
          external_jQuery_default().each(dataTransfer.Type, function (idx, type) {
            // skip moz-specific Type
